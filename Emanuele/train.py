...
train_dl, test_dl, _ = net.load_data_voxels('./data/sub-06400_ndwi.mat', 139, 139, num_y_cols=1, batch_size=128,  pca_var=0.90, device=device)

in_dim = train_dl.dataset[:][0].shape[1]
model = net.voxelnet(in_dim, 10, 1).to(device)
